...
import { MapPin, Phone, Mail, Instagram, Clock, Send, Check } from 'lucide-react';
...
const contactInfo = [
  ...
  },
  {
    icon: Mail,
    label: 'Email',
    value: 'hello@designlovers.com.au',
  },
  {
    icon: Clock,
    label: 'Hours',
    ...
    <section id="contact" className="bg-dl-ivory">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[700px]">
          ...
          <div className="bg-dl-champagne py-16 px-8 md:px-12 lg:px-16 flex flex-col justify-center">
          ...
          {/* Right Column - Form */}
          <div className="bg-white py-16 px-8 md:px-12 lg:px-16 flex flex-col justify-center">
            <div className="max-w-md mx-auto lg:mx-0 w-full">
              <h3 className="font-serif text-2xl md:text-3xl text-dl-coffee mb-2">
                Send an Inquiry
              </h3>
              ...
              {/* Success Message */}
              {isSuccess && (
                <div className="mb-8 p-4 bg-green-50 border border-green-200 rounded-sm flex items-center gap-3 animate-fade-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full bg-transparent border-0 border-b border-dl-coffee/20 py-3 font-sans text-dl-coffee focus:outline-none focus:border-dl-gold transition-colors duration-300 cursor-pointer appearance-none"
                    >
                      {eventTypes.map((type) => (
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="
                    w-full sm:w-auto bg-dl-gold text-white font-sans text-xs uppercase tracking-[0.2em] 
                    px-12 py-4 flex items-center justify-center gap-3
                    hover:bg-dl-coffee disabled:opacity-50 disabled:cursor-not-allowed
